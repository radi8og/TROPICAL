  ...
  return (
    <div className="p-5 shadow-md h-[80px] justify-between items-center flex">
      ...
      <div className="flex gap-5 items-center">
        <Link
          href={"/checkout"}
          className="flex outline hover:bg-yellow-200 hover:text-black hover:scale-105 transition-all ease-in-out px-10 rounded-lg py-2 gap-2 items-center text-md font-bold"
        >
        ...
        {!user ? (
          <Link
            href={"/login"}
            className={
              "cursor-pointer outline hover:bg-green-200 hover:text-black hover:scale-105 transition-all ease-in-out px-4 rounded-lg py-2 gap-2 items-center text-md font-semibold"
            }
          >
            Login
          </Link>
